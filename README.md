...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 72daef77-25e4-4448-8186-62b2b5e62ff1
```

> `72daef77-25e4-4448-8186-62b2b5e62ff1` is the password of the certificate, you can change it to any password you want.
